  ...
  return (
    <section className='flex flex-col sm:flex-row w-full'>
        <div className='w-full sm:w-[50%]'>
            ...
            <br />
            <p className='px-[21%]'>You can easily contact with us via <a className='font-semibold' href="mailto:support@website-seo-checker.net">support@website-seo-checker.net</a></p>
        </div>
        <div className='w-full sm:w-[50%]'>
